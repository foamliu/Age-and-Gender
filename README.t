...
#|图片大小|网络|性别准确度(验证集)|年龄MAE(验证集)|年龄损失函数|批量大小|归一化|
|---|---|---|---|---|---|---|---|
|1|96x112|ResNet-18|89.764%|TBD|分类(交叉熵)|40|除255|
|2|224x224|ResNet-18|90.641%|TBD|分类(交叉熵)|32|除255|
|3|224x224|ResNet-50|90.034%|TBD|分类(交叉熵)|32|除255|
